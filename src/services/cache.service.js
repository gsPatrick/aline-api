...
const performFullWarmup = async () => {
    ...
    try {
        ...
        // Step 4: Cache 90 matches for each team (past, current, future) - DISABLED FOR TESTING
        // UNCOMMENT LATER to enable full history caching
        /*
        ...
        */
        console.log('⏭️  Etapa 4 DESABILITADA - apenas testando date range');
        ...
        while (currentDate <= endDate) {
            ...
            try {
                ...
                if (fixtures.length > 0) {
                    ...
                    for (const fixture of fixtures) {
                        try {
                            // Call getMatchStats to cache COMPLETE match data
                            // This includes H2H, statistics, corners, trends, etc.
                            await getMatchStats(fixture.id);
                            cachedCount++;
                        } catch (error) {
